...
1. Make an [Issue](https://github.com/ligofff/lgf-asset-postprocessors/issues/new)
...
```json
    {
        "dependencies": {
            "com.ligofff.lgf-asset-postprocessors": "https://github.com/YOUR_USER/lgf-asset-postprocessors.git"
        }
    }
```
